  ...
  return (
    <>
      <PageHero
        ...
        backgroundClassName="bg-[url('https://images.unsplash.com/photo-1597829733984-0c2f3d5d0e38?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')] bg-cover bg-center"
      />
